...
from moment.tasks.RF_Classification_finetune import RFClassificationFinetuning
from moment.utils.config import Config
from moment.utils.utils import control_randomness, make_dir_if_not_exists, parse_config

NOTES = "Supervised finetuning on RF Classification datasets"
...
def RF_Classification(
    ...
    task_obj = RFClassificationFinetuning(args=args)
